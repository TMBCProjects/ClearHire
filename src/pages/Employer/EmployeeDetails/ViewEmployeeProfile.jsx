    ...
    <>
      <div className="main-container">
        <div className="row d-flex justify-content-between align-items-center my-3">
          ...
          <div className="col-6 d-flex justify-content-end">
            <button className="btn">
              ...
              <a
                className="text-color-green fw-bold view-resume-btn"
            ...
            >
              ...
              <span className=" fw-bold portfolio-text">Portfolio</span>
            </a>
          </div>
        </div>
        <div className="row mt-5 d-flex justify-content-center align-items-center mb-5">
          ...
          <div className="col-md-4 mt-md-0 mt-3 d-flex justify-content-center align-items-center empDetailsProgress">
