...
export default function SearchEmployee() {
  ...
  return (
    <>
        ...
        <div>
          ...
          <div className="search">
            ...
            <button className="searchbtn">
              <img src={search} alt="search" style={{ width: "50%" }} />
            </button>
          </div>
          ...
          <div className="empCards">
            ...
            >
              <Meta title="Courtney" description="Senior Designer" />
      ...
      <Modal
        title="Add quick feedback for Courtney"
        open={isModalOpen}
        onOk={handleOk}
